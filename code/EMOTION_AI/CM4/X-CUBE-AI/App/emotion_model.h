...
#ifndef AI_EMOTION_MODEL_H
#define AI_EMOTION_MODEL_H
#pragma once

#include "emotion_model_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_EMOTION_MODEL_MODEL_NAME          "emotion_model"
#define AI_EMOTION_MODEL_ORIGIN_MODEL_NAME   "ecg_emotion_model_2class_500in"

/******************************************************************************/
#define AI_EMOTION_MODEL_ACTIVATIONS_ALIGNMENT   (4)
#define AI_EMOTION_MODEL_INPUTS_IN_ACTIVATIONS   (4)
#define AI_EMOTION_MODEL_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_EMOTION_MODEL_IN_NUM        (1)

AI_DEPRECATED
#define AI_EMOTION_MODEL_IN \
  ai_emotion_model_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_EMOTION_MODEL_IN_SIZE { \
  AI_EMOTION_MODEL_IN_1_SIZE, \
}
#define AI_EMOTION_MODEL_IN_SIZE_BYTES { \
  AI_EMOTION_MODEL_IN_1_SIZE_BYTES, \
}
#define AI_EMOTION_MODEL_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_EMOTION_MODEL_IN_1_CHANNEL     (500)
#define AI_EMOTION_MODEL_IN_1_SIZE        (500)
...
AI_DEPRECATED
#define AI_EMOTION_MODEL_OUT \
  ai_emotion_model_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_EMOTION_MODEL_OUT_SIZE { \
  AI_EMOTION_MODEL_OUT_1_SIZE, \
}
#define AI_EMOTION_MODEL_OUT_SIZE_BYTES { \
  AI_EMOTION_MODEL_OUT_1_SIZE_BYTES, \
}
#define AI_EMOTION_MODEL_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_EMOTION_MODEL_OUT_1_CHANNEL     (2)
#define AI_EMOTION_MODEL_OUT_1_SIZE        (2)
#define AI_EMOTION_MODEL_OUT_1_SIZE_BYTES  (8)

/******************************************************************************/
#define AI_EMOTION_MODEL_N_NODES (9)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup emotion_model
 ...
 * @ref ai_emotion_model_create. Both the activations memory buffer 
 ...
 * using @ref ai_emotion_model_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_emotion_model_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_emotion_model_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_EMOTION_MODEL_*
 * defines into file @ref emotion_model.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_emotion_model_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_EMOTION_MODEL_H */
