...
#define AI_EMOTION_MODEL_MODEL_SIGNATURE     "43e11755eda72ada071d0aa16a95a0f5"
...
#define AI_TOOLS_DATE_TIME   "Thu Feb  8 15:59:54 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  5, 0x0,
  AI_SHAPE_INIT(4, 1, 500, 1, 1), AI_STRIDE_INIT(4, 4, 4, 2000, 2000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  15, 0x0,
  AI_SHAPE_INIT(4, 500, 32, 1, 1), AI_STRIDE_INIT(4, 1, 250, 8000, 8000),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  16, 0x0,
  AI_SHAPE_INIT(4, 32, 16, 1, 1), AI_STRIDE_INIT(4, 1, 16, 256, 256),
